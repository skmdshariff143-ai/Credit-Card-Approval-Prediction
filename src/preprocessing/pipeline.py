...
from configs.constants import TARGET_COL, NUMERICAL_COLS, CATEGORICAL_COLS
    ...
    def execute_full_pipeline(self):
        ...
        try:
            ...
            self.num_cols = [
                ...
                "AGE_YEARS", "YEARS_EMPLOYED", "INCOME_PER_MEMBER", "FINANCIAL_STABILITY_SCORE"
            ]
            # Categorical features include original text categories and new binned categories
            self.cat_cols = [
                "CODE_GENDER", "FLAG_OWN_CAR", "FLAG_OWN_REALTY", "NAME_INCOME_TYPE", 
                "NAME_EDUCATION_TYPE", "NAME_FAMILY_STATUS", "NAME_HOUSING_TYPE", 
                "OCCUPATION_TYPE", "INCOME_GROUP", "AGE_GROUP", "EXPERIENCE_BUCKET"
            ]
