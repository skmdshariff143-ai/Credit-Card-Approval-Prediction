...
from configs.constants import NUMERICAL_COLS, CATEGORICAL_COLS, BINARY_COLS, TARGET_COL
...
class DataValidator:
    ...
    def validate_dataset(self, app_df: pd.DataFrame, credit_df: pd.DataFrame) -> bool:
        ...
        # 2. Missing values & null percentages
        ...
        # 4. Invalid numeric ranges (Income > 0, family size >= 1, children >= 0)
        invalid_ranges = []
        ...
        # 5. Invalid dates (Birth days must be negative offset)
