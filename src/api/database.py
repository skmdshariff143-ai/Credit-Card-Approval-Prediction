...
class DatabaseManager:
    ...
    def add_prediction(self, input_features, prediction=None, probability=None, app_id=None, gender=None, income=None, employment=None, experience=None, children=None, debt=None, risk_level=None, model=None, recommendation=None) -> int:
        ...
        if isinstance(input_features, dict) and prediction is not None and probability is not None:
            ...
            recommendation = recommendation or ("Manual review required" if prediction == "Rejected" else "Auto-approved credit facility")
        else:
        ...
        with self._get_connection() as conn:
            ...
            cursor.execute(
                ...
                """,
                (app_id, timestamp, gender, income, employment, experience, children, debt, prediction, probability, risk_level, model, recommendation, raw_json)
            )
            conn.commit()
