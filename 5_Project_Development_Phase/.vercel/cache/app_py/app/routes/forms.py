...
class CreditApprovalForm(FlaskForm):
    ...
    # ==========================================
    code_gender = SelectField("Gender", choices=[("F", "Female"), ("M", "Male")], validators=[DataRequired()])
    ...
    flag_unemployed = BooleanField("Is Unemployed / Retired Pensioner", default=False)
    ...
    flag_own_car = SelectField("Owns Car", choices=[("N", "No"), ("Y", "Yes")], validators=[DataRequired()])

    flag_own_realty = SelectField("Owns Property", choices=[("Y", "Yes"), ("N", "No")], validators=[DataRequired()])
